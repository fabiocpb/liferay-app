...
function DoacaoGrafico(){
  ...
  const urlgetamount = "none";

  //Url antiga de pegar quantidade
  //`https://coding-liferay.herokuapp.com/api/v1/form/get/amount`

  const get = async () => {
    const connectAPI = await (await fetch(urlgetamount))
